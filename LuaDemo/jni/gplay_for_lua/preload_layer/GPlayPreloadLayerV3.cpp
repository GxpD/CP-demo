...
namespace gplay {
    ...
    public:
        static PreloadMessageBox* create(const std::string& message, 
            ...
            const MessageBoxCallback& callback1, const MessageBoxCallback& callback2)
        {
        ...
        static PreloadMessageBox* create(const std::string& message, 
            const std::string& btnText1, const MessageBoxCallback& callback1)
        {
            auto box = new (std::nothrow) PreloadMessageBox();
            if (box)
            {
        ...
        void onEnter()
        {
            ...
            {
                _bg = LayerColor::create(Color4B(0,0,0,160));
            ...
            const MessageBoxCallback& callback1, const MessageBoxCallback& callback2)
        {
            ...
            auto bg = Sprite::create("res/gplay_custom_resource/new_wendang_bg.png");
            ...
            setContentSize(Size(contentSizeWidth, contentSizeHeight));
            ...
            if (btnText2.empty())
            {
                buttonBG1 = Sprite::create("res/gplay_custom_resource/new_progress_button3.png");
            ...
            {
                buttonBG1 = Sprite::create("res/gplay_custom_resource/new_progress_button1.png");
                addChild(buttonBG1);
                buttonBG2 = Sprite::create("res/gplay_custom_resource/new_progress_button2.png");
                addChild(buttonBG2);
                _button1 = Label::createWithSystemFont(btnText1,"serif",fontSize);
                addChild(_button1);
    ...
    bool GPlayPreloadLayer::init()
    {
        ...
        //响应按键事件，下载时玩家如果按返回按键则弹出提示框
        _keyboardListener = EventListenerKeyboard::create();
        _keyboardListener->onKeyPressed = [](EventKeyboard::KeyCode, Event*) {};
        _keyboardListener->onKeyReleased = [preloadLayer](EventKeyboard::KeyCode keyCode, Event*) {
            if(!s_showQuitConfirm || keyCode != EventKeyboard::KeyCode::KEY_ESCAPE)
                return;

            s_showQuitConfirm = false;
            auto& choiceTextConf = s_preloadTextMap[s_choiceLanguage];

            auto box = PreloadMessageBox::create(choiceTextConf.quitTip, choiceTextConf.quitCancelText, 
                choiceTextConf.quitConfirmText,
                [](PreloadMessageBox* sender1) {
                    sender1->runAction(Sequence::create(DelayTime::create(0.01f), 
            ...
            box->setPosition(Vec2(preloadLayer->getContentSize().width/2, 
                preloadLayer->getContentSize().height/2));
        ...
        auto loadBg = Sprite::create("res/gplay_custom_resource/new_progress_bg.png");
        ...
        auto spriteProgressBar = Sprite::create("res/gplay_custom_resource/new_progress_bar.png");
